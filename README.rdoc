...
So assuming that you completely draw your state machine with valid_transitions (which is always recommended) you can use the model class methods state_classes and state_events to get a list of states and events respectively.
